...
public interface AuthApiContract {
        ...
        @Operation(summary = "Login SUAP", description = "Autentica um usuário do IFPB usando credenciais SUAP")
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Login SUAP realizado com sucesso", content = @Content(schema = @Schema(implementation = AuthResponse.class))),
                        @ApiResponse(responseCode = "401", description = "Credenciais SUAP inválidas", content = @Content(schema = @Schema(implementation = AuthResponse.class))),
                        @ApiResponse(responseCode = "502", description = "Erro de comunicação com SUAP", content = @Content(schema = @Schema(implementation = AuthResponse.class))),
                        @ApiResponse(responseCode = "422", description = "Dados de entrada inválidos", content = @Content(schema = @Schema(implementation = AuthResponse.class)))
        })
